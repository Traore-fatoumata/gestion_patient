...
<head>
    ...
    <title>Nouveau Patient - Back-Office</title>
...
<body class="bg-gray-100 font-sans">
    ...
    <section class="container mx-auto py-12">
        <h1 class="text-3xl font-bold mb-6">Nouveau Patient</h1>
        @if ($errors->any())
        ...
        @endif
        <form action="{{ route('patients.store') }}" method="POST" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance') }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea name="adresse" id="adresse" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('adresse') }}</textarea>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="courriel" id="courriel" value="{{ old('courriel') }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
                <label for="groupe_sanguin" class="block text-gray-700 font-semibold mb-2">Groupe sanguin</label>
                <input type="text" name="groupe_sanguin" id="groupe_sanguin" value="{{ old('groupe_sanguin') }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
                <label for="antecedents_medicaux" class="block text-gray-700 font-semibold mb-2">Antécédents médicaux</label>
                <textarea name="antecedents_medicaux" id="antecedents_medicaux" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('antecedents_medicaux') }}</textarea>
            </div>
            <div class="mt-4">
